...
- **Ultralove Black** (Current) - Ultra-dark theme with deep black backgrounds for low-light coding
- **Ultralove White** (Planned) - Clean light theme with high contrast for bright environments
- **Ultralove Blue** (Planned) - Blue-tinted theme for a calming coding experience
...
│   ├── ultralove-white-color-theme.json  # Planned
│   └── ultralove-blue-color-theme.json   # Planned
